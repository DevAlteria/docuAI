...
echo 
curl -X POST http://iadoc.alteria.vpn.alonsom.com/n8n/rest/owner/setup -H "Content-Type: application/json" -d '{"email":"dev@alteriaautomation.com","firstName":"alteria","lastName":"dev","password":"AlteriaKillM3!"}'
